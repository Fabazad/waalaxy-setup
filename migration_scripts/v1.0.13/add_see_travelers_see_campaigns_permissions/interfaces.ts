...
export enum PermissionNameEnum {
    ...
    see_travelers = 'see_travelers',
    see_campaigns = 'see_campaigns',
}
...
export type ImpersonatePermission<WithAll extends boolean = true> = {
    name: 'impersonate';
    params: { users: WithAll extends true ? Array<string> | 'all' : Array<string> };
};

export type ImportInCRMPermission<WithAll extends boolean = true> = {
    name: 'import_in_crm';
    params: { users: WithAll extends true ? Array<string> | 'all' : Array<string> };
};

export type SeeTravelersPermission<WithAll extends boolean = true> = {
    name: 'see_travelers';
    params: { users: WithAll extends true ? Array<string> | 'all' : Array<string> };
};

export type SeeCampaignsPermission<WithAll extends boolean = true> = {
    name: 'see_campaigns';
    params: { users: WithAll extends true ? Array<string> | 'all' : Array<string> };
};

export type CompanyPermission<Update extends boolean = true> =
    | ImportInCRMPermission<Update>
    | ImpersonatePermission<Update>
    | SeeTravelersPermission<Update>
    | SeeCampaignsPermission<Update>;

export type LinkedPermission = SequenceComplexityPermission | SequenceTagPermission | CompanyPermission;
export type PopulatedLinkedPermission = SequenceComplexityPermission | SequenceTagPermission | CompanyPermission<false>;

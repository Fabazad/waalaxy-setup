...
export const CompanyModel = (c: Connection) => c.model<ICompany>('Company', CompanySchema);
...
export const ProspectModel = (c: Connection) => c.model<Prospect>('Prospect', ProspectSchema);
...
export const UsersRegroupmentModel = (c: Connection) => c.model<UsersRegroupment>('UsersRegroupment', usersRegroupmentSchema);
...
export const DuplicatedProspectModel = (c: Connection) => c.model<DuplicatedProspect>('DuplicatedProspect', duplicatedProspectSchema);
